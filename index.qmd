...
subtitle: "An analysis of incidence and survival, 1983–2019"
author: "Raju Rimal"
...
## Research is what I'm doing when I don't know what I'm doing. {.center}
...
## Scientific research is one of the most exciting and rewarding of occupations. {.center}
...
## Overall incidence and mortality in Norway {background-color="floralwhite"}
...
## Diagnosis, thickness pattern, and T categories {background-color="honeydew" transition="none"}
...
## Missing thickness and imputation {background-color="floralwhite"}
...
## Incidence rate, adjustment, and segmented regression {auto-animate="true" background-color="floralwhite"}
...
## Changes in melanoma incidence rate {.smaller background-color="honeydew"}
...
## Incidence rate by anatomic site {background-color="honeydew"}
...
## Incidence rate by melanoma sub-type {background-color="honeydew"}
...
## Incidence by age, period of diagnosis and cohort {background-color="honeydew"}
